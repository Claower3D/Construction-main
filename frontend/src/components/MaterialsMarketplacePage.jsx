...
export default function MaterialsMarketplacePage({ onBack, hideHeader = false }) {
  ...
  const products = [
    ...
    // 8. ЖБИ кольца, крышки и люки — ИП «Медина» (Манарбек, г. Караганда)
    {
      id: 'medina-1',
      category: 'zhbi',
      title: 'Кольцо КС 15.9 (1500×900 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 28000,
      unit: 'шт',
      weightKg: 1000,
    ...
    },
    {
      id: 'medina-2',
      category: 'zhbi',
      title: 'Кольцо КС 15.6 (1500×600 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 19000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-3',
      category: 'zhbi',
      title: 'Кольцо КС 10.9 (1000×900 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 19000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-4',
      category: 'zhbi',
      title: 'Кольцо КС 10.3 (1000×300 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 9000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-5',
      category: 'zhbi',
      title: 'Кольцо КС 7.3 (700×300 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 7500,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-6',
      category: 'zhbi',
      title: 'Кольцо опорное КО 6 (600×900×100 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 4000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-7',
      category: 'zhbi',
      title: 'Крышка колодца 2ПП-15-1 (d=1700 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 19000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-8',
      category: 'zhbi',
      title: 'Крышка колодца 1ПП-15-1У усиленная (d=1700 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 26000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-9',
      category: 'zhbi',
      title: 'Крышка колодца 1ПП-15-2 усиленная под автонагрузку (d=1700 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 35000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-10',
      category: 'zhbi',
      title: 'Днище колодца ПН-15 (d=1700 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 20000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-11',
      category: 'zhbi',
      title: 'Крышка колодца 1ПП-10-1У усиленная (d=1200 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 14000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-12',
      category: 'zhbi',
      title: 'Крышка колодца 1ПП-10-2 усиленная (d=1200 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 21000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-13',
      category: 'zhbi',
      title: 'Днище колодца ПН-10 (d=1200 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 15000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-14',
      category: 'zhbi',
      title: 'Люк железобетонный ЖБ (750×100 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 4000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-15',
      category: 'zhbi',
      title: 'Люк чугунно-бетонный КПР-14 (900×100 мм)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 5000,
      unit: 'шт',
    ...
    },
    {
      id: 'medina-16',
      category: 'zhbi',
      title: 'Люк полимерный тяжелый (нагрузка 25 тн)',
      supplier: 'ИП «Медина» (Манарбек)',
      city: 'Караганда',
      price: 10000,
      unit: 'шт',
