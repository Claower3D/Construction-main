...
export default function VoiceControlWidget() {
  const message = "Здравствуйте! Я пишу с сайта QazGost AI. У меня есть вопрос по платформе.";
  const whatsappUrl = `https://wa.me/77716983869?text=${encodeURIComponent(message)}`;
